package com.nexcool.console.compments.netty.server;
...
import com.nexcool.console.compments.netty.config.NettyConfig;
...
public class NettyTCPServer extends AbstractNettyServer {
    ...
    public void startServer() throws Exception {
        try {
            ...
            serverBootstrap.group(getBossGroup(),getWorkerGroup()).channel((Class<? extends ServerChannel>) NioServerSocketChannel.class).childHandler(getChannelInitializer());
//            serverBootstrap.group(getWorkerGroup()).channel((Class<? extends ServerChannel>) NioServerSocketChannel.class).childHandler(getChannelInitializer());
            // 绑定端口，启动并监听
