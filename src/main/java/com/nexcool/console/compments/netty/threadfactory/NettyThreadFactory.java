package com.nexcool.console.compments.netty.threadfactory;
...
public class NettyThreadFactory implements ThreadFactory {
 ...
 public NettyThreadFactory(String name, boolean daemon) { 
     this(name, daemon, -1); 
 } 

 public NettyThreadFactory(String name, boolean daemon, int priority) { 
     this.name = name; 
     this.daemon = daemon; 
